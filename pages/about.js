...
const About = () => {
  return (
    <Layout title="О нас">
      ...
      <p>
        Нас тут двое (Андрей и Лина). Мы любим ввязываться в сотню авантюр и ещё
        любим котиков (=^.^=).
      </p>
      <p>
        После путешествия в Исландию в 2016, мы решили, что пора нам завести
        свой блог. После 156-го вопроса о нашей поездке, мы укрепились в этой
        мысли. И понеслась.
      </p>
      <Image
        centered
      ...
      <p>
        Тут мы отпускаем в вольное плавание по просторам интернета наши отчеты о
        поездках, делимся фотографиями, даем советы, от которых бы не отказались
        сами до поездки.
      </p>
      ...
      <ul>
        ...
        <li>
          Играет на гитаре и аккордеоне (которого, на радость соседям, у нас
          нет)
        </li>
      ...
      <ul>
        ...
        <li>
          В свободное от работы время - едет на работу. А ещё, учит языки и
          пытается 4-ый раз пройти курс по моделям и методам оценки финансовых
          активов на Coursera
        </li>
        <li>
      ...
      <p>
        А что за название странное? Долго мы о нем не думали, оно к нам влетело
        стремительно и покорило нас своей нелепостью. Олейник и Лось? Очевидно
        же, "ОЛОЛОСЬ"!
      </p>
      <p>
        В общем, берите печенек, устраивайтесь поудобнее, и добро пожаловать в
