...
class Post extends React.Component {
  ...
  static async getInitialProps({ query: { id }, store, ...rest }) {
      ...
      <Layout as="article" title="О нас">
        ...
        <PostContainer>
          <p>
            ...
            Францию (большим, по грандиозности для нас, а не по времени
            пребывания там). Потому, мы провели в северной столице Италии один
            очень жаркий день, которым тут немного и поделимся.
          </p>
          <p>
          ...
          <p>
            ...
            русском, так что мне не пришлось даже пытаться выдавать свой
            испанский за итальянский в этой стране, где с учебой английского
            мало кто заморачивается. Если вам нужны контакты гостиницы - пишите,
            мы поделимся. К условиям мы особо привередливы не были, если что. На
            одну ночь, да ещё и так дёшево - она вполне себя оправдала.
          </p>
          ...
          <p>
            ...
            дорогой. Потому.. Мы ходили пешком :) А надо сказать, это мой
            любимый транспорт. Потому, пока были силы (а это где-то на 30 км
            блужданий по городу) - мы просто гуляли по нему. Изредка прибегая к
            услугам местного.. Метро. Система такая же, как и по всей Европе -
            покупаешь в автомате билет на время и зоны, перед тем, как заходить
            в транспорт - компостируешь его в доступном автомате (или, на
            крайняк, пишешь ручкой время, когда сел в него) Трамвайная сеть (она
            довольно-таки развита - 17 линий). Воспользовались мы ею один раз -
            утром, от гостинницы до вокзала. Проехали бесплатно в древнем
            вагончике начала ХХ века. По заверениям сидящего рядом дедушки
            полиглота (который говорил с нами на немецком, французском,
            испанском и английском) - так и надо. Мы не поняли, то ли это в
            выходные по утрам бесплатно, то ли этот винтажный вагончик вообще
            всегда катает всех так бескорыстно.
          </p>
          ...
          <p>
            ...
            достаточно будет только рапсечатать ваши билеты (для этого надо
            нагло подойти в самое начало очереди, и сказать пропускающему
            служащему, что у вас онлайн билет. Очередь на печать несравнимо
            меньше, потому вас, почти наверняка, сразу пропустят. В нашем случае
            - перед нами был всего 1 человек.
          </p>
          ...
          <p>
            Не сильно растроившись, мы проведали фонтан "Свадебный торт",
            который стоит прям возле входа в замок, и держали наш путь дальше.
          </p>
          <p>
          ...
          <p>
            ...
            значился собор Дуомо. Он находится неподалеку, на одноименной
            площади Piazza del Duomo.
          </p>
          <p>
          ...
          <p>
            А виды, открывающиеся с крыши - стоят тех тысячи (или сколько их
            там?) ступенек вверх по винтовой лестнице.
          </p>
          <p>
          ...
          <p>
            ...
            туристически наполненная галерея Витторио Эмануэле. Старый
            красивенный пассаж с кучей бутиков, с неприличным количеством
            мишленовских ресторанов и семизвездочной гостинницей (не уверена,
            есть ли еще где-то такие, вообще).
          </p>
          <p>
          ...
          <p>
            ...
            вечер, я уронила зайца в воду (того, что на рюкзаке в профиль
            висит).
          </p>
          <p>
          ...
          <p>
            ...
            /пушистого свидетельства моей инфантильности. К слову, так как
            Андрей у мамы инженер, все обошлось.
          </p>
          <p>
...
export default withRedux(initStore, null, {})(Post)
